...
export function Payment() {
  ...
  const [debtData, setDebtData] = useState<any>(location.state?.debtData || null);
  ...
  const handleCompletePayment = async () => {
    ...
    try {
      ...
      navigate('/orders'); // Navigate to invoice list or somewhere else
    } catch (err: any) {
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 p-6">
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          <button 
            ...
            className={cn("w-full text-left p-4 rounded-xl border-2 transition-all flex items-center justify-between", paymentMethod === 'cash' ? "border-emerald-500 bg-emerald-50" : "border-slate-200 bg-white hover:border-emerald-200")}
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-xs text-slate-500 font-medium">Thanh toán bằng tiền mặt</div>
              </div>
            </div>
          ...
          <button 
            ...
            className={cn("w-full text-left p-4 rounded-xl border-2 transition-all flex items-center justify-between", paymentMethod === 'transfer' ? "border-blue-500 bg-blue-50" : "border-slate-200 bg-white hover:border-blue-200")}
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-xs text-slate-500 font-medium">Quét mã QR hoặc chuyển khoản</div>
              </div>
            </div>
          ...
          <button 
            ...
            className={cn("w-full text-left p-4 rounded-xl border-2 transition-all flex items-center justify-between", paymentMethod === 'card' ? "border-indigo-500 bg-indigo-50" : "border-slate-200 bg-white hover:border-indigo-200")}
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-xs text-slate-500 font-medium">Thanh toán bằng thẻ ATM/Visa</div>
              </div>
            </div>
          ...
          <button 
            ...
            className={cn("w-full text-left p-4 rounded-xl border-2 transition-all flex items-center justify-between", paymentMethod === 'wallet' ? "border-purple-500 bg-purple-50" : "border-slate-200 bg-white hover:border-purple-200")}
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-xs text-slate-500 font-medium">MoMo, ZaloPay, VNPay...</div>
              </div>
            </div>
          ...
          <button 
            ...
            className={cn("w-full text-left p-4 rounded-xl border-2 transition-all flex items-center justify-between", paymentMethod === 'combined' ? "border-orange-500 bg-orange-50" : "border-slate-200 bg-white hover:border-orange-200")}
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-xs text-slate-500 font-medium">Thanh toán bằng nhiều hình thức</div>
              </div>
            </div>
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-6 items-center sm:items-start justify-center">
                  ...
                  <div className="p-4 bg-white border-2 border-blue-100 rounded-2xl shadow-sm flex flex-col items-center">
                     ...
                     <div className="w-48 h-48 bg-slate-100 rounded-xl overflow-hidden mb-2">
        ...
        <div className="lg:col-span-5 flex flex-col h-full bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
          ...
          <div className="p-6 bg-slate-50 border-t border-slate-100 shrink-0 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-4">
              {!isDebtMode && (
                <>
                  <button 
                    ...
                    className="px-5 py-3 text-sm font-bold text-slate-600 bg-white hover:bg-slate-100 rounded-xl border border-slate-200 transition-colors"
                  >
                    Hủy đơn
                  </button>
                  <button 
                    ...
                    className="px-5 py-3 text-sm font-bold text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-xl border border-blue-200 transition-colors"
                  >
                    Lưu tạm
                  </button>
                </>
              ...
              {isDebtMode && (
                <button 
                  onClick={() => navigate('/finances/debts')}
                  className="px-5 py-3 text-sm font-bold text-slate-600 bg-white hover:bg-slate-100 rounded-xl border border-slate-200 transition-colors"
                >
                  Hủy thu nợ
                </button>
              ...
              <button 
                ...
                className="flex-1 py-3 px-2 text-sm font-black text-white bg-emerald-600 hover:bg-emerald-700 rounded-xl transition-colors shadow-lg shadow-emerald-500/30 flex items-center justify-center gap-2"
              >
